...
output "public_ipv4_subnets" {
  ...
  value = {
    "public_ipv4_a" = aws_subnet.ipv4_public_a.id
    "public_ipv4_b" = aws_subnet.ipv4_public_b.id
    "public_ipv4_c" = aws_subnet.ipv4_public_c.id
  }
}
...
output "public_ipv6_subnets" {
  description = "Map of public subnet IDs"
  value = {
    "public_ipv6_a" = aws_subnet.ipv6_public_a.id
    "public_ipv6_b" = aws_subnet.ipv6_public_b.id
    "public_ipv6_c" = aws_subnet.ipv6_public_c.id
  }
}
...
output "public_dual_stack_subnets" {
  description = "Map of public subnet IDs"
  value = {
    "public_dual_stack_a" = aws_subnet.dual_stack_public_a.id
    "public_dual_stack_b" = aws_subnet.dual_stack_public_b.id
    "public_dual_stack_c" = aws_subnet.dual_stack_public_c.id
  }
}
